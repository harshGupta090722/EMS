                                ...
                                return (
                                    <tr key={leave._id || leave.id}>
                                        ...
                                        <td className="text-xs text-slate-500">
                                            {format(new Date(leave.startDate), 'MMM dd')} -{formatDate(new Date(leave.endDate), 'MMM dd,yyyy')}
                                        </td>
                                                ...
                                                {leave.status === "PENDING" && (
                                                    <div className='flex justify-center gap-2'>
                                                        <button
                                                            ...
                                                            className='p-1.5 rounded-md bg-emerald-50 text-emerald-600 hover:bg-emerald-100 hover:bg-emerald-100 transition-colors'>
