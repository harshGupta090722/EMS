                ...
                return (
                  <tr key={record._id || record.id}>
                    <td className="px-6 py-4 font-medium text-slate-900">
                      {formatDate(new Date(record.date), 'MMM dd, yyyy')}
                    </td>

                    <td className="px-6 py-4 text-slate-600">
                      {record.checkIn ? formatDate(new Date(record.checkIn), 'hh:mm a') : '---'}
                    </td>

                    <td className="px-6 py-4 text-slate-600">
                      {record.checkOut ? formatDate(new Date(record.checkOut), 'hh:mm a') : '---'}
                    </td>
