    ...
    return (
        <div
            ...
            <div
                ...
                {/*--------------Form------------*/}
                <form onSubmit={handleSubmit} className='p-6 spave-y-5'>
                    {/*-----------------leave type------------*/}
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="reason" rows={3} required className='resize-none' placeholder='Briefly describe why you need this leave...'></textarea>
                    </div>
