  ...
  const portalOptions = [
    {
      to: "/login/admin",
      title: "Admin Portal",
      description: "Manage employees,attendance,payroll,and system configurations",
      icon: ShieldIcon
    },
    {
      to: "/login/employee",
            ...
            {portalOptions.map((portal) => (
              ...
              >
                <div className="relative z-10 flex items-center justify-between gap-4 sm:gap-5">
                  ...
                  <ArrowRightIcon className="w-4 h-4 text-slate-400 group-hover:text-indgo-600 group-hover:translate-x-1 transition-all duration-300" />
                </div>
              </Link>
            ))}
          </div>
